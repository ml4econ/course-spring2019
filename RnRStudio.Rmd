...
1. Go to **Tools -> General Options -> General** and set the Save workspace to .RData on exit to *NEVER*. This option improves the replicability of your projects since it causes you to start every project in a new R session, i.e., a clean environment and without any packages pre-loaded.
