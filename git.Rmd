...
Once git, GitHub account and GitHub desktop are all set, open GitHub Desktop and go [here](https://github.com/huji-ml4econ/course-spring2019) to open our __course-spring2019__ repository. Once in the repository, click on the green **Clone or download** button (top right, above the folders and files pane). If done correctly, GitHub Desktop should prompt you with a request for a local destination for the __course-spring2019__ repository. Choose where you want to install your local copy of the repo, click OK, and we're done. 

### Keeping your local repo synced

You keep your copy of the __course-spring2019__ repo up to date by following these steps:
