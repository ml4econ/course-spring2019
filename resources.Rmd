...
__NOTE:__ All materials and lecture notes will be available on the [class website](https://huji-ml4econ.github.io/course-spring2019/lectures.html). The following list of references and links may be useful. However, note that they _do not_ necessarily cover all the material we plan to cover in the class.
...
* [Susan Athey](https://www.gsb.stanford.edu/faculty-research/faculty/susan-athey) (Stanford) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/susan_athey)  
...
* [Francis Diebold](https://www.sas.upenn.edu/~fdiebold/) (Penn) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/FrancisDiebold)  
...
* [Maximilian Kasy](https://maxkasy.github.io/home/) (Harvard) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/maxkasy)  

* [Grant McDermott](http://grantmcdermott.com/) (University of Oregon) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/grant_mcdermott)  

* [Sendhil Mullainathan](https://www.chicagobooth.edu/faculty/directory/m/sendhil-mullainathan)   (Chicago) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/m_sendhil)  

* [Jann Spiess](https://scholar.harvard.edu/spiess) (Harvard) [<i class="fa fa-twitter-square"></i> ](https://twitter.com/jannspiess)   
